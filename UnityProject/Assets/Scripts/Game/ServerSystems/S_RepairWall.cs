                ...
                for (int k = 0; k < na_Grid.Length; k++)
                {
                    ...
                    unsafe {
                        ...
                        if (c_CurrentGridPos.WallStates[(int)mc_CurrentMessage.WallDirection] != (byte)WallStates.Damaged)
                            Debug.Log($"Already Functioning: {c_CurrentGridPos}");
                        else
                        {
                            c_CurrentGridPos.WallStates[(int)mc_CurrentMessage.WallDirection] = (byte)WallStates.Closed;
                            ...
                            for (int l = 0; l < na_Grid.Length; l++)
                            {
                                ...
                                {
                                    case WallIndexes.Up:
                                        c_UpdatedDuplicateWall.WallStates[(int)WallIndexes.Down] = (byte)WallStates.Closed;
                                        break;
                                    case WallIndexes.Down:
                                        c_UpdatedDuplicateWall.WallStates[(int)WallIndexes.Up] = (byte)WallStates.Closed;
                                        break;
                                    case WallIndexes.Left:
                                        c_UpdatedDuplicateWall.WallStates[(int)WallIndexes.Right] = (byte)WallStates.Closed;
                                        break;
                                    case WallIndexes.Right:
                                        c_UpdatedDuplicateWall.WallStates[(int)WallIndexes.Left] = (byte)WallStates.Closed;
                                        break;
                                    default:
                                        break;
                                }
